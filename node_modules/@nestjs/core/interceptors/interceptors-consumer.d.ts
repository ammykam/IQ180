...
export declare class InterceptorsConsumer {
    intercept<TContext extends ContextType = ContextType>(interceptors: NestInterceptor[], args: any[], instance: Controller, callback: (...args: any[]) => any, next: () => Promise<any>, type?: TContext): Promise<any>;
