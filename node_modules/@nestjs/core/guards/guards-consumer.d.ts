...
export declare class GuardsConsumer {
    tryActivate<TContext extends ContextType = ContextType>(guards: CanActivate[], args: any[], instance: Controller, callback: (...args: any[]) => any, type?: TContext): Promise<boolean>;
